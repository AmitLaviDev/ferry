...
- [x] **Phase 22: Backend and Action Code Changes** - Backend dispatches to `ferry.yml`; setup action exposes `resource_type` output
- [x] **Phase 23: Unified Workflow Template and Docs** - Create `ferry.yml` template with conditional jobs per type; update documentation
- [x] **Phase 24: Test Repo Migration and E2E Validation** - Migrate test repo to unified workflow; prove all 3 resource types deploy via single file
...
**Plans:** 1 plan
Plans:
- [x] 22-01-PLAN.md -- Unify dispatch to ferry.yml and add resource_type output
...
**Plans:** 1 plan
Plans:
- [x] 23-01-PLAN.md -- Add unified ferry.yml template to setup.md and remove per-type workflow sections from type pages
...
**Plans:** 1 plan
Plans:
- [x] 24-01-PLAN.md -- Migrate test repo to unified ferry.yml and validate all 3 resource types E2E
...
| 23. Unified Workflow Template and Docs | 1/1 | Complete | 2026-03-10 |
| 24. Test Repo Migration and E2E Validation | 1/1 | Complete | 2026-03-10 |
